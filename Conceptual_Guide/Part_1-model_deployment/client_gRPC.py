...
import cv2
import numpy as np
import tritonclient.grpc as grpcclient  # 修改为 gRPC 客户端
...
if __name__ == "__main__":
    ...
    client = grpcclient.InferenceServerClient(url="localhost:8001")  # gRPC端口是8001
    ...
    recognition_input = grpcclient.InferInput(
